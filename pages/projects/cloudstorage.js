  ...
  return (
    <Layout title="Visit Brăila">
      <Container>
        ...
        <Paragraph>
          A clone o cloud storage concept (e.g. Google Drive, iCloud). This was one of my first significantly bigger
          project since I started programming. Developing this desktop app I have practiced more the P2P File Sharing
        ...
        <List ml={4} my={4}>
          <ListItem>
            <Meta>Source</Meta>
            <Link as={NextLink} target="_blank" href="https://github.com/MoryokaV/Cloud-Storage-App">
