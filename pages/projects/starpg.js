...
import thumbnail1 from 'public/images/projects/starpg_01.png'
import thumbnail2 from 'public/images/projects/starpg_02.png'

const Work = () => {
  return (
    <Layout title="Star P&G">
      <Container px="0">
        <WorkTitle>
          Star P&G <Badge>2025</Badge>
        </WorkTitle>
        ...
        <List ml={{ base: 0, sm: 4 }} my={4}>
          <ListItem>
            ...
            <Link as={NextLink} target="_blank" href="https://starpg.ro/">
              https://starpg.ro/
