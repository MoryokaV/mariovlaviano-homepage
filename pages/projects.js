  ...
  return (
    <Layout>
      <Container>
        ...
        <SimpleGrid columns={[1, 1, 2]} gap={6}>
          <Section>
            <ProjectGridItem id="visitbraila" title="Visit Brăila" thumbnail={thumbVisitBraila}>
              My home town cross-platform mobile app made for citizens and tourists
            </ProjectGridItem>
          </Section>
          <Section>
          ...
          <Section delay={0.1}>
            <ProjectGridItem id="cloudstorage" title="Cloud Storage" thumbnail={thumbCloudStorage}>
              A clone of cloud storage concept. Store, preview and download files
            </ProjectGridItem>
          </Section>
          <Section delay={0.1}>
            <ProjectGridItem id="cosmeticsshop" title="eCommerce App" thumbnail={thumbCosmeticsShop}>
        ...
        <SimpleGrid columns={[1, 1, 2]} gap={6}>
          <Section delay={0.3}>
            <ProjectGridItem id="bts" title="Brăila Tech Sprint" thumbnail={thumbBTS}>
